...
from .routers.internal import login, user, menu, roles, dictonary, job, host, playbook, category
...
app.mount(
    "/static/upload", StaticFiles(directory=settings.upload_dir), name="static")
...
app.include_router(category.router, tags=['分类字典'])
...
app.include_router(assets_router, tags=['资产管理'])
