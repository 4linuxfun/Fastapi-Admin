...
// 用户相关接口
export const requestLogin = (username, password, captcha_code, captcha_key) => POST('/api/login', {username, password, captcha_code, captcha_key})
export const refreshToken = () => POST('/api/refresh', {})
