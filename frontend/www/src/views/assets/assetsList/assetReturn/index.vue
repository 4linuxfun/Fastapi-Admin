<!-- 资产领用页面 -->
<template>
    <el-dialog v-model="visible" title="资产退回" width="70%" class="form-inline" destroy-on-close>
        <el-row>
        ...
        <el-table v-loading="loading" :data="tableData" style="width: 100%;margin-top: 10px;" border>
            ...
            <el-table-column label="操作" align="center">
                <template #default="scope">
                    <el-button link type="primary" @click="handleReturn(scope.row)">退回</el-button>
                </template>
            </el-table-column>
            ...
            <el-table-column prop="remarks" label="具体位置"></el-table-column>
        </el-table>
        ...
        <ReturnDialog ref="returnDialogRef" @success="freshCurrentPage" />
    </el-dialog>
</template>
...
function handleReturn(row) {
    returnDialogRef.value.show(row)
}
